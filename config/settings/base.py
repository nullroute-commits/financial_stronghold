...
SECRET_KEY = os.environ.get("SECRET_KEY", "dev-only-secret-key-replace-in-production-12345678901234567890")
...
MIDDLEWARE = [
    ...
    "app.monitoring.MonitoringMiddleware",
