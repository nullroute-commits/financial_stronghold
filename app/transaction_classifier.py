...
class TransactionClassifierService:
    ...
    def auto_classify_and_categorize(
        self, 
    ...
    def add_classification_pattern(
        self, 
    ...
    def get_transactions_by_classification(
        ...
        return self.tagging_service.get_tagged_resources(
            tag_filters={"classification": classification.value},
            resource_type="transaction",
            tenant_type=tenant_type,
            tenant_id=tenant_id
        )[:limit] if limit else self.tagging_service.get_tagged_resources(
            tag_filters={"classification": classification.value},
            resource_type="transaction",
            tenant_type=tenant_type,
            tenant_id=tenant_id
