...
class DataTag(BaseModel, TenantMixin):
    ...
    __table_args__ = (
        UniqueConstraint(
            "tag_type", "tag_key", "tag_value", "resource_type", "resource_id", name="uq_data_tag_resource"
        ),
    )
...
class TagHierarchy(BaseModel):
    ...
    __table_args__ = (UniqueConstraint("parent_tag_id", "child_tag_id", name="uq_tag_hierarchy"),)
...
class TaggedResourceMetrics(BaseModel, TenantMixin):
    ...
    __table_args__ = (
        UniqueConstraint(
            "tag_combination_hash", "resource_type", "period_start", "period_end", name="uq_tagged_metrics_period"
        ),
    )
