...
class TransactionAnalyticsService:
    ...
    def get_classification_analytics(
        ...
        distribution = self.classifier.analyze_classification_distribution(
    ...
    def get_category_analytics(
        ...
        spending_insights = self._calculate_spending_insights(
    ...
    def get_transaction_patterns(
        ...
        tenant_type: str,
        tenant_id: str,
        pattern_type: str = "all"  # "classification", "category", "all"
    ) -> Dict[str, Any]:
    ...
    def _calculate_spending_insights(self, category_amounts: Dict[str, Any]) -> Dict[str, Any]:
        ...
        insights = {
            ...
            "average_transaction_amount": sum(data["average_amount"] for data in category_amounts.values()) / len(category_amounts) if category_amounts else 0
        }
    ...
    def _analyze_classification_category_correlation(self, tenant_type: str, tenant_id: str) -> Dict[str, Any]:
        ...
        classification_tags = self.db.query(DataTag).filter(
        ...
        category_tags = self.db.query(DataTag).filter(
