...
class RBACManager:
    ...
    def create_role(
        self, name: str, description: str = None, permissions: List[str] = None, created_by: Optional[str] = None
    ) -> Optional[str]:
        """
        Create a new role.
    ...
    def create_permission(
        self, name: str, resource: str, action: str, description: str = None, created_by: Optional[str] = None
    ) -> Optional[str]:
        """
    ...
    def _clear_user_cache(self, user_id: str):
        ...
        cache_keys = [f"user_permissions:{user_id}", f"user_roles:{user_id}"]
