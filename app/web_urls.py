...
from app.web_views import (
    dashboard_home,
    accounts_list, account_detail, account_create, account_edit,
    transactions_list, transaction_detail, transaction_create, transaction_edit,
    budgets_list, budget_detail, budget_create, budget_edit,
    fees_list, fee_detail, fee_create, fee_edit,
    analytics_dashboard,
    home_redirect
)
